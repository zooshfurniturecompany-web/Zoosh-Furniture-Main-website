...
const DEFAULT_CATEGORIES: Category[] = [
  { id: "cat-0", name: "L-Shape Sofas", slug: "l-shape-sofas", room_slug: "living", description: "Bespoke handcrafted L-shaped and modular sectional sofas", image_url: "/images/products/sf002-main.jpg", display_order: 1, status: "active", created_at: new Date().toISOString() },
  { id: "cat-1", name: "Sofas", slug: "sofas", room_slug: "living", description: "Bespoke handcrafted 3-seater, 2-seater, and sectional sofas", image_url: "/images/catalog/page_14_img_00.webp", display_order: 2, status: "active", created_at: new Date().toISOString() },
  { id: "cat-2", name: "Lounge Chairs", slug: "lounge-chairs", room_slug: "living", description: "Sculptural accent and lounge chairs", image_url: "/images/catalog/page_15_img_00.webp", display_order: 3, status: "active", created_at: new Date().toISOString() },
  { id: "cat-3", name: "Arm Chairs", slug: "arm-chairs", room_slug: "living", description: "Comfortable ergonomic solid wood arm chairs", image_url: "/images/catalog/page_16_img_00.webp", display_order: 4, status: "active", created_at: new Date().toISOString() },
  { id: "cat-4", name: "Centre Tables", slug: "centre-tables", room_slug: "living", description: "Solid wood and organic stone centre tables", image_url: "/images/catalog/page_17_img_00.webp", display_order: 5, status: "active", created_at: new Date().toISOString() },
  { id: "cat-5", name: "Side Tables", slug: "side-tables", room_slug: "living", description: "Accent side tables and plinths", image_url: "/images/catalog/page_18_img_00.webp", display_order: 6, status: "active", created_at: new Date().toISOString() },
  { id: "cat-6", name: "Console Tables", slug: "console-tables", room_slug: "entryway", description: "Architectural entryway and living console tables", image_url: "/images/catalog/page_27_img_00.webp", display_order: 7, status: "active", created_at: new Date().toISOString() },
  { id: "cat-7", name: "Dining Tables", slug: "dining-tables", room_slug: "dining", description: "Grand handcrafted solid timber dining tables", image_url: "/images/catalog/page_21_img_00.webp", display_order: 8, status: "active", created_at: new Date().toISOString() },
  { id: "cat-8", name: "Dining Chairs", slug: "dining-chairs", room_slug: "dining", description: "Ergonomic wood and woven cane dining chairs", image_url: "/images/catalog/page_23_img_00.webp", display_order: 9, status: "active", created_at: new Date().toISOString() },
  { id: "cat-9", name: "Bed Cots", slug: "bed-cots", room_slug: "bedroom", description: "Solid wood plinth beds with floating nightstands", image_url: "/images/catalog/page_22_img_00.webp", display_order: 10, status: "active", created_at: new Date().toISOString() },
  { id: "cat-10", name: "Benches", slug: "benches", room_slug: "entryway", description: "Solid wood and upholstered entryway benches", image_url: "/images/catalog/page_24_img_00.webp", display_order: 11, status: "active", created_at: new Date().toISOString() }
];
