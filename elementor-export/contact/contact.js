document.addEventListener("DOMContentLoaded", function() {
  ...
  // 1. WhatsApp Dynamic Links
  const generalLink = window.getGeneralWhatsAppLink ? window.getGeneralWhatsAppLink("general") : "#";
  const contactWhatsapp = document.getElementById("zooshContactWhatsapp");
  if (contactWhatsapp) contactWhatsapp.setAttribute("href", generalLink);

  // 2. Curated creations grid (first 3 items)
  const productGrid = document.getElementById("zooshContactProductGrid");
  ...
  function renderShowcase() {
    ...
    const showcase = catalog.slice(3, 7); // Pick items 4 to 7 to show different selection
  ...
  // 3. Interactive Contact Form submissions
  const contactForm = document.getElementById("zooshContactForm");
  const formLoading = document.getElementById("zooshFormLoading");
  const formSuccess = document.getElementById("zooshFormSuccess");
  const resetFormBtn = document.getElementById("zooshResetFormBtn");
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function(e) {
      ...
      // Simulate network request delays (1.5 seconds)
      setTimeout(function() {
        // Hide spinner, show success overlay panel
  ...
  // =====================================================
  // 4. QUICK VIEW OVERLAY MODAL LOGIC (SHARED ENGINE)
  // =====================================================
