document.addEventListener("DOMContentLoaded", function() {
  ...
  const productGrid = document.getElementById("zooshAboutProductGrid");
  const catalog = window.ZOOSH_PRODUCTS || [];

  // 1. Render Curated Curation Grid (first 3 items in the list)
  function renderCuration() {
    if (!productGrid) return;
    productGrid.innerHTML = "";

    const curated = catalog.slice(0, 3);
  ...
  // =====================================================
  // 2. QUICK VIEW OVERLAY MODAL LOGIC (SHARED ENGINE)
  // =====================================================
